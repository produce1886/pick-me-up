		...
		<Wrapper>
			...
			<Body>
				<Text level={2} color="#232735">
					Body textbox Continually unleash technically sound products before installed base
					opportunities. Holisticly harness granular e-business with e-business ROI. Interactively
					andemic process improvements...
				</Text>
			</Body>
			<Bottom></Bottom>
		</Wrapper>
